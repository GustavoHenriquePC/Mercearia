USE [master]
GO
/****** Object:  Database [Mercearia]    Script Date: 20/10/2023 09:09:36 ******/
CREATE DATABASE [Mercearia]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Mercearia', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS2019A\MSSQL\DATA\Mercearia.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Mercearia_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS2019A\MSSQL\DATA\Mercearia_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [Mercearia]
GO
/****** Object:  Table [dbo].[Cliente]    Script Date: 20/10/2023 09:09:36 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Produto]    Script Date: 20/10/2023 09:09:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 20/10/2023 09:09:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
